...
class Pomodoro(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, help_text='Unique ID for this particular pomodoro across whole library')
    ...
    def get_absolute_url(self):
        """Returns the url to access a deail record for this pomodoro."""
